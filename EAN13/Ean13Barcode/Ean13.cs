...
namespace Ean13Barcode
{
    public class Ean13
    {
        ...
        private float _fWidth = (37.29f * 0.95f);
        private float _fHeight = (12.93f * 0.95f);
        private float _fFontSize = (8.0f * 0.95f);
        private float _fScale = (1.0f * 0.95f);
        ...
        {
            float tempWidth = (this.Width * this.Scale) * 4;
            float tempHeight = (this.Height * this.Scale) * 4;
